                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Cảm ơn bạn đã chấp nhận điền biểu mẫu</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="{{ route('postForm') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="card bg-secondary.bg-gradient">
                                                <div class="card-body card-block ">
                                                        ...
                                                        <label for="exampleInputName2" class=" col-lg-1">Mức 1</label>
                                                        <label for="exampleInputName2" class=" col-lg-1">Mức 2</label>
                                                        <label for="exampleInputName2" class=" col-lg-1">Mức 3</label>
                                                        <label for="exampleInputName2" class=" col-lg-1">Mức 4</label>
                                                        <label for="exampleInputName2" class=" col-lg-1">Mức 5</label>
                                                </div>
                                            </div>
                                @foreach ($part as $pa)
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <input  name="rating{{$qui->id}}[]"  style="border: solid 1px black" type="text" id="exampleInputName2" placeholder="Nhập tại đây" required="" class=" col-lg-5">
                                    </div>
                                                @else
                                    <div class="card-body card-block">
                                        <label for="exampleInputName2" class=" col-lg-6">{{$qu->name}}</label>
                                        <input type="radio" name="rating{{$qui->id}}[]" value="1"  class=" col-lg-1">
                                        <input type="radio" name="rating{{$qui->id}}[]" value="2"  class=" col-lg-1">
                                        <input type="radio" name="rating{{$qui->id}}[]" value="3"  class=" col-lg-1">
                                        <input type="radio" name="rating{{$qui->id}}[]" value="4"  class=" col-lg-1">
                                        <input type="radio" name="rating{{$qui->id}}[]" value="5"  class=" col-lg-1">    
                                    </div>
                                                @endif
                                        @endif
                                    @endforeach
