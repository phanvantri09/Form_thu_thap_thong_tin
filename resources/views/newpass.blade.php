        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              ...
              @endif
              <form action="{{ route('postpasss') }}" method="POST" enctype="multipart/form-data">
                @csrf @method('POST')
                ...
                <div class="form-outline mb-4">
                  ...
                  @enderror
                  <input type="hidden" value="{{$email}}" name="email" id="form3Example3" class="form-control form-control-lg">
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  <button type="submit" class="btn btn-primary btn-lg"
                    style="padding-left: 2.5rem; padding-right: 2.5rem;">Đổi mật khẩu mới</button>
